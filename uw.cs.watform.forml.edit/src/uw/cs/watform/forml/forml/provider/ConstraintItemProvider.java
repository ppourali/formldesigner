...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.CONSTRAINT__PREDICATES);
			childrenFeatures.add(FormlPackage.Literals.CONSTRAINT__MACRO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.CONSTRAINT__PREDICATES,
				 FormlFactory.eINSTANCE.createPredicate()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.CONSTRAINT__MACRO,
