...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider extends ConceptItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_ctrl_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_ctrl_feature", "_UI_Relationship_type"),
				 FormlPackage.Literals.RELATIONSHIP__CTRL,
				 true,
				 false,
				 false,
