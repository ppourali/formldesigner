...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormlPackage.Literals.TRANSITION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormlPackage.Literals.TRANSITION__SRC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDstPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_dst_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_dst_feature", "_UI_Transition_type"),
				 FormlPackage.Literals.TRANSITION__DST,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.TRANSITION__PRIORITY);
			childrenFeatures.add(FormlPackage.Literals.TRANSITION__TRIG);
			childrenFeatures.add(FormlPackage.Literals.TRANSITION__GUARD);
			childrenFeatures.add(FormlPackage.Literals.TRANSITION__LIST);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.TRANSITION__PRIORITY,
				 FormlFactory.eINSTANCE.createPriority()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.TRANSITION__TRIG,
				 FormlFactory.eINSTANCE.createTrigger()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.TRANSITION__GUARD,
				 FormlFactory.eINSTANCE.createGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.TRANSITION__LIST,
