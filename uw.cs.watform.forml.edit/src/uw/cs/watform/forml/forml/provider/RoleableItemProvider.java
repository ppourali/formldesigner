...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Roleable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleableItemProvider extends ExprRefItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RoleableItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormlPackage.Literals.CONCEPT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.ROLEABLE__ATTRIBUTES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Roleable"));
	}
	...
	public String getText(Object object) {
		String label = ((Roleable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Roleable_type") :
			getString("_UI_Roleable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Roleable.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.ROLEABLE__ATTRIBUTES,
