...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormlPackage.Literals.STATE_MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.STATE_MACHINE__REGIONS);
			childrenFeatures.add(FormlPackage.Literals.STATE_MACHINE__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.STATE_MACHINE__REGIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.STATE_MACHINE__TRANSITIONS,
