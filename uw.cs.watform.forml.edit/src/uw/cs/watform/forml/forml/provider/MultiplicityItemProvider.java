...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Multiplicity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiplicityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Multiplicity_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Multiplicity_value_feature", "_UI_Multiplicity_type"),
				 FormlPackage.Literals.MULTIPLICITY__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addManyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Multiplicity_many_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Multiplicity_many_feature", "_UI_Multiplicity_type"),
				 FormlPackage.Literals.MULTIPLICITY__MANY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.MULTIPLICITY__CARDINALITY);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Multiplicity_type") + " " + multiplicity.getValue();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.MULTIPLICITY__CARDINALITY,
