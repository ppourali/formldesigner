...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider extends ComponentItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.REGION__INIT);
			childrenFeatures.add(FormlPackage.Literals.REGION__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.REGION__INIT,
				 FormlFactory.eINSTANCE.createInitState()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.REGION__STATES,
