...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.SYSTEM__WORLDMODEL);
			childrenFeatures.add(FormlPackage.Literals.SYSTEM__BEHAVIOURMODEL);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(uw.cs.watform.forml.forml.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.SYSTEM__WORLDMODEL,
				 FormlFactory.eINSTANCE.createWorldModel()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.SYSTEM__BEHAVIOURMODEL,
