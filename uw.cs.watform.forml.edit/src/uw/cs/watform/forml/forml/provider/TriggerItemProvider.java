...
/**
 * This is the item provider adapter for a {@link uw.cs.watform.forml.forml.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormlPackage.Literals.TRIGGER__OVERRIDE);
			childrenFeatures.add(FormlPackage.Literals.TRIGGER__WCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.TRIGGER__OVERRIDE,
				 FormlFactory.eINSTANCE.createOverride()));

		newChildDescriptors.add
			(createChildParameter
				(FormlPackage.Literals.TRIGGER__WCE,
