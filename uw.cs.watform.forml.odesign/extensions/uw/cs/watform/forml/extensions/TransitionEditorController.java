...
public class TransitionEditorController extends AbstractEEFCustomWidgetController {
    ...
    public TransitionEditorController(EEFCustomWidgetDescription description, IVariableManager variableManager, IInterpreter interpreter,
