...
import uw.cs.watform.forml.viewpoint.xtext.support.StringUtil;

/* largely inspired by "org.eclipse.xtext.gmf.glue" from XText examples */
public class CustomEmbeddedEditorForPropertiesView {
	...
	public EmbeddedEditor xTextEmbeddedEditor;

	public CustomEmbeddedEditorForPropertiesView(Injector xtextInjector, EObject semElem) {
		//this.hostEditPart = editPart;
		this.originalSemanticElement=semElem;
	...
	protected EObject resolveSemanticElement() {
		...
		return this.originalSemanticElement;
	}

	
	public void showEditor(Composite parent) {
		try {
			EObject originalSemanticElement = resolveSemanticElement();
	...
	protected void createXtextEditor(Composite parentComposite) throws Exception {
		...
		xtextEditorComposite = new Decorations(parentComposite,SWT.BORDER);
		//xtextEditorComposite.setLayout(new FillLayout());
		GridData data = new GridData(GridData.FILL_HORIZONTAL);
		xtextEditorComposite.setLayout(new GridLayout());
		xtextEditorComposite.setLayoutData(data);
