...
public class EmbeddedXtextEditorForPropertiesPage {
	 ...
	 */
	public EmbeddedXtextEditorForPropertiesPage(Composite control, Injector injector, int style) {
		fControl = control;
		fStyle = style;
	 ...
	 * @param fileExtension
	 */
	public EmbeddedXtextEditorForPropertiesPage(Composite control, Injector injector) {
	...
	private void createEditor(Composite parent) {
		...
		manager.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager mgr) {
				EmbeddedXtextEditorForPropertiesPage.this.menuAboutToShow(mgr);
			}
		});
...
//			EmbeddedXtextResource asStringResource = new EmbeddedXtextResource();
			...
			if (!asStringResource.getErrors().isEmpty() || (asStringResource.getParseResult() != null && !asStringResource.getParseResult().hasSyntaxErrors())) {
