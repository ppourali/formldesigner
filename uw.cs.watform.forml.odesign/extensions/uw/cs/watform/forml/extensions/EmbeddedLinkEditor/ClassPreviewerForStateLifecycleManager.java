...
public class ClassPreviewerForStateLifecycleManager extends AbstractEEFWidgetLifecycleManager {
	...
	private State modelElement;

	public ClassPreviewerForStateLifecycleManager(EEFCustomWidgetDescription description, IVariableManager variableManager,
	...
	private void createEditor_V0(Composite parent) {
		...
		try {
			...
			if (this.modelElement instanceof State && this.modelElement != null) {
				List<Roleable> roleables = new ArrayList<Roleable>();
				roleables = ModelUtils.GetRelatedIncomingOutGoingRoleables(this.modelElement);
