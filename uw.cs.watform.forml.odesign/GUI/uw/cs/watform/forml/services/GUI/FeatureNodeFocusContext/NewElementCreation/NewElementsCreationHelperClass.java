...
import uw.cs.watform.forml.services.GUI.FeatureNodeFocusContext.CustomCompositeFeaturePreview;
import uw.cs.watform.forml.services.GUI.FeatureNodeFocusContext.CustomListForClasses;
...
public class NewElementsCreationHelperClass {
	...
	public static void createNewElement(Class type, Composite composite_ExpandBarHolder, Roleable selectedRoleable,
			CustomListForClasses selectedList, CustomCompositeFeaturePreview customControlFeaturePreview,
			String newName) {
	...
	public static boolean CreateNewAssociation(Object srcElement, CustomListForClasses targetList,
		...
		boolean successOperation = ModelOperations2.createAssociations(FPC_SingletonData.getCurrentRoleable(),
				(Roleable) srcElement);

		if (successOperation) {
			RejointModelsInMemory();
			if (targetList == null || selectionItemText == null || selectionItemText.equals(""))
				FPC_SingletonData.getFeaturesListDialog().populateList();
			else
				FPC_SingletonData.getFeaturesListDialog().populateList(targetList, selectionItemText);
	...
	public static void setType(Object data, Object type, CustomListForClasses releventLeftSideList,
			CustomCompositeFeaturePreview customControlFeaturePreview) {
...
//		// RepopulateLists(Attribute.class, releventLeftSideList, this);
	...
	public static boolean ChangeAssociationType(Object srcElement, CustomListForClasses targetList,
			String selectionItemText) {
		boolean successOperation = ModelOperations2.chageAssociationType(FPC_SingletonData.getCurrentRoleable(),
				(Roleable) srcElement);
	...
	protected static void RepopulateLists(Class type, CustomListForClasses selectedList,
			CustomCompositeFeaturePreview customControlFeaturePreview, String newName) {
