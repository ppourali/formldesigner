...
import uw.cs.watform.forml.services.GUI.CustomPopupMenuForWCA;
import uw.cs.watform.forml.services.GUI.FrmShellForWCAActionView;

public class CustomSearchTextForWCA extends Composite {
	...
	private Shell shell;
	FrmShellForWCAActionView container;

	public Feature parentFeature;

	public CustomSearchTextForWCA(Shell parent, FrmShellForWCAActionView parentForm, Feature containingFeature) {
	...
	protected void CreatePopUpMenu() {
		...
		CustomPopupMenuForWCA popupMenu = new CustomPopupMenuForWCA(this.txtFilter, this.parentFeature, this);
