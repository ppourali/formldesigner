...
public class FrmCustomActionSelectionWizard extends JDialog {
	...
	public FrmCustomActionSelectionWizard(WorldModel worldmodel, Transition tran, Feature feature) {
	...
	private void MakeTree() {
		...
		if (this.parentFeature.getOutputlist() != null) {
			EList<RefMessage> messages = this.parentFeature.getOutputlist().getOutputs();
		...
		for (Feature f : features) {
			...
			if (f.getOutputlist() != null) {
				EList<RefMessage> messages = f.getOutputlist().getOutputs();
				for (RefMessage m : messages) {
					DefaultMutableTreeNode messageTreeNode = new DefaultMutableTreeNode();
					messageTreeNode.setUserObject(m.getRefMsg());
	...
	private void ConstructDesign() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmCustomActionSelectionWizard.class
		...
		MyRendererForActionSelection renderer = new MyRendererForActionSelection(this.parentFeature);
...
class MyRendererForActionSelection extends DefaultTreeCellRenderer {

	Icon messageIcon = new ImageIcon(FrmCustomActionSelectionWizard.class
			.getResource("/uw/cs/watform/forml/services/GUI/res/icon_CreateFeature.png"));

	Icon featureIcon = new ImageIcon(FrmCustomActionSelectionWizard.class
			.getResource("/uw/cs/watform/forml/services/GUI/res/icon_CreateFeatureMessage.png"));

	Feature parentFeature;

	public MyRendererForActionSelection(Feature parentf) {
