...
public class CustomListForClasses extends Composite {
	...
	private Table list;
	private Image aggregationImage = SWTResourceManager.getImage(FrmShellForSetGuardGraphicallyDialog.class,
			"/uw/cs/watform/forml/services/GUI/res/icon_Aggregation.png");
	private Image compositionImage = SWTResourceManager.getImage(FrmShellForSetGuardGraphicallyDialog.class,
			"/uw/cs/watform/forml/services/GUI/res/icon_Composition.png");
	private Image associationImage = SWTResourceManager.getImage(FrmShellForSetGuardGraphicallyDialog.class,
			"/uw/cs/watform/forml/services/GUI/res/icon_Association.png");
	private Image generalizationImage = SWTResourceManager.getImage(FrmShellForSetGuardGraphicallyDialog.class,
