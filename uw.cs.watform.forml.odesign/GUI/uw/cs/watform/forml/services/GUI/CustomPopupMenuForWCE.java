...
public class CustomPopupMenuForWCE {
	...
	private CustomSearchTextForWCE CustomSearchCompositeContainer;

	public CustomPopupMenuForWCE(StyledText txtFilter, Feature currentFeature, CustomSearchTextForWCE customSearchText) {
