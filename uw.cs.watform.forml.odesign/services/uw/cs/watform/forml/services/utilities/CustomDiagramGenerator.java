 ...
 */
abstract public class CustomDiagramGenerator {
	 ...
	 */
	public CustomDiagramGenerator(DiagramEditPart dgrmEP) {
		this._dgrmEP = dgrmEP;
...
//		List sortedEditparts = sortSelection(editparts);
	...
	private void paintFigure(Graphics graphics, IFigure figure) {
		...
		CustomDiagramImageUtils.translateTo(abBounds, figure, printableLayer);
...
//	}
	...
	public org.eclipse.swt.graphics.Rectangle calculateImageRectangle(
			List editparts) {
		Rectangle rect = CustomDiagramImageUtils.calculateImageRectangle(editparts,
