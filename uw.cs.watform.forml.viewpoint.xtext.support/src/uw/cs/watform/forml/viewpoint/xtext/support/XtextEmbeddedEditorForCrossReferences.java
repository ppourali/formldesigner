...
public class XtextEmbeddedEditorForCrossReferences {
	...
	public XtextEmbeddedEditorForCrossReferences(Injector xtextInjector, boolean isEditable) {
	...
	protected void createXtextEditor() throws Exception {
		...
		//} else {
		//	xtextPartialEditor.updateModel(pre_editable_suff_Fixes[0], pre_editable_suff_Fixes[1],
