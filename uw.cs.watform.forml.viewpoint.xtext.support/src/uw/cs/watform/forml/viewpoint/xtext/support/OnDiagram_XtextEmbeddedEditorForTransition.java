...
public class OnDiagram_XtextEmbeddedEditorForTransition extends AbstractXtextEmbeddedEditor{
	

	public OnDiagram_XtextEmbeddedEditorForTransition(IGraphicalEditPart editPart,
			Injector xtextInjector) {
		super(editPart, xtextInjector);
	}

//	@Override
//	protected void showEditor(EObject originalelem, DiagramEditPart diagramEditPart, Composite referenceCompsiteOnShell) 
//	{
