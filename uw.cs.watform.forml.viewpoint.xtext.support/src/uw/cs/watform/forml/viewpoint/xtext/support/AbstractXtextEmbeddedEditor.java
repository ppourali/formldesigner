...
public abstract class AbstractXtextEmbeddedEditor {
	...
	public AbstractXtextEmbeddedEditor(IGraphicalEditPart editPart, Injector xtextInjector) {
	...
	protected void createXtextEditor() throws Exception {
		...
		// xtextEditorComposite.setLayout(new FillLayout(SWT.HORIZONTAL));
		// xtextEditorComposite.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
		// true, 1, 1));
